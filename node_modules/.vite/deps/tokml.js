...
// node_modules/strxml/index.js
var require_strxml = __commonJS({
  "node_modules/strxml/index.js"(exports, module) {
...
// node_modules/tokml/index.js
var require_tokml = __commonJS({
  "node_modules/tokml/index.js"(exports, module) {
    var strxml = require_strxml();
    var tag = strxml.tag;
    ...
    module.exports = function tokml(geojson, options) {
      ...
      return '<?xml version="1.0" encoding="UTF-8"?>' + tag(
        "kml",
        tag(
          "Document",
          documentName(options) + documentDescription(options) + root(geojson, options)
        ),
    ...
    function feature(options, styleHashesArray) {
      return function(_) {
        ...
        return styleDefinition + tag(
          "Placemark",
          name(_.properties, options) + description(_.properties, options) + extendeddata(_.properties) + timestamp(_.properties, options) + geometryString + styleReference
        );
      };
    }
    ...
    function documentName(options) {
      return options.documentName !== void 0 ? tag("name", options.documentName) : "";
    }
    function documentDescription(options) {
      return options.documentDescription !== void 0 ? tag("description", options.documentDescription) : "";
    }
    ...
    var geometry = {
      ...
      Polygon: function(_) {
        ...
        var outer = _.coordinates[0], inner = _.coordinates.slice(1), outerRing = tag(
          "outerBoundaryIs",
    ...
    function polygonAndLineStyle(_, styleHash) {
      var lineStyle = tag("LineStyle", [
        tag("color", hexToKmlColor(_["stroke"], _["stroke-opacity"]) || "ff555555") + tag("width", _["stroke-width"] === void 0 ? 2 : _["stroke-width"])
      ]);
      var polyStyle = "";
...
export default require_tokml();
//# sourceMappingURL=tokml.js.map
